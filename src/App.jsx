...
function AppContent() { return <><ScrollToTop /><Navbar /><Routes><Route path="/" element={<Home />} /><Route path="/plan" element={<MealPlanner />} /><Route path="/results" element={<Results />} /><Route path="/recipe/:id" element={<RecipeDetailsPage />} /><Route path="/saved" element={<SavedMeals />} /><Route path="*" element={<Home />} /></Routes><Footer /><Toast /></>; }
